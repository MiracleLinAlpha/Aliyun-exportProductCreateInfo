...
public class Nas_Api {
    public static String DescribeFileSystems(requestParams rp) {
        try {
            Map<String, Object> requestParams = new HashMap<String, Object>();
            requestParams.put("action", "DescribeFileSystems");
            requestParams.put("product", "NAS");
            requestParams.put("Version", "2017-06-26");
...
//            System.out.println("DescribeFileSystems API Success!");
            return result;
        } catch (Exception e) {
            System.out.println("DescribeFileSystems API Error!");
            e.printStackTrace();
            return null;
        }
    }
